...
export function Testimonial() {
    ...
    // Removed scroll-hijacking wheel event per user request constraints

    const current = testimonials[activeIndex]

    return (
        <div className="flex items-center justify-center py-24 bg-background overflow-hidden overflow-hidden" style={{ minHeight: '80vh' }}>
            <div ref={containerRef} className="relative w-full max-w-5xl px-8" onMouseMove={handleMouseMove}>
                ...
                <motion.div
                    className="absolute -left-8 top-1/2 -translate-y-1/2 text-[18rem] md:text-[28rem] font-bold text-gray-900/[0.03] select-none pointer-events-none leading-none tracking-tighter"
                    ...
                    <div className="flex-1 md:pl-16 py-12">
                        ...
                        <div className="relative mb-12 min-h-[140px]">
                            <AnimatePresence mode="wait">
                                <motion.blockquote
                                    key={activeIndex}
                                    className="text-3xl md:text-5xl font-light text-gray-900 leading-[1.15] tracking-tight"
                                    initial="hidden"
                                    animate="visible"
                                    exit="exit"
                                >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <motion.div
                                        className="w-8 h-px bg-gray-900"
                                        initial={{ scaleX: 0 }}
                                        animate={{ scaleX: 1 }}
