            ...
            <div style={card}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div>
                        ...
                        <input type="text" value={profile?.username || ''} disabled style={{ ...inputStyle, opacity: 0.5, cursor: 'not-allowed' }} />
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '4px', flexWrap: 'wrap' as const }}>
                        <button onClick={handleSave} disabled={saving} style={{
                            ...
                            fontSize: '14px', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '6px', transition: 'all 0.15s',
                        }}>
                        ...
                        <button onClick={handlePasswordReset} style={{
                            ...
                            fontSize: '14px', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '6px', transition: 'all 0.15s',
                        }}>
                            <Lock style={{ width: '14px', height: '14px' }} /> Reset Password
                        </button>
                    </div>
                    {passwordMsg && <p style={{ fontSize: '13px', fontWeight: 500, color: 'var(--dash-success-text)', margin: '0' }}>{passwordMsg}</p>}
                </div>
            </div>
            ...
            <div style={card}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '8px', borderTop: '1px solid var(--dash-border)' }}>
                    ...
                    <button onClick={toggleTheme} style={{
                        ...
                        border: '1px solid var(--dash-border)', cursor: 'pointer',
                        background: 'var(--dash-bg)', color: 'var(--dash-text-primary)',
                        fontSize: '14px', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '8px', transition: 'all 0.15s',
                    }}>
