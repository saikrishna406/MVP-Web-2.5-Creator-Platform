        ...
        <div className="pub-page">
                ...
                <div className="pub-info-col">
                    <div className="pub-row-1">
                        ...
                        {discord?.external_channel_id && (
                            <a href={discord.discord_invite_url || `https://discord.com/channels/${discord.external_channel_id}`} target="_blank" rel="noopener noreferrer" className="pub-btn-discord">
                                <ExternalLink size={13}/> Join Discord Server
                            </a>
                        )}
                    </div>
            ...
            {discord?.external_channel_id && (
                <div className="pub-discord-banner">
                    ...
                    <a href={discord.discord_invite_url || `https://discord.com/channels/${discord.external_channel_id}`} target="_blank" rel="noopener noreferrer" className="pub-btn-discord-sm"><ExternalLink size={13}/> Join Discord Server</a>
                </div>
            )}
            {/* Tabs */}
